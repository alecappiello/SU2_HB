...
//      solver_container[val_iZone][MESH_0][ADJFLOW_SOL]->node[iPoint]->SetHBSource_Direct(solver_container[val_iZone][MESH_0][FLOW_SOL]->node[iPoint]->GetHB_Source());
    }
    if (turbulent){
      for (iPoint = 0; iPoint < geometry_container[val_iZone][MESH_0]->GetnPoint(); iPoint++){
...
//        solver_container[val_iZone][MESH_0][ADJTURB_SOL]->node[iPoint]->SetHBSource_Direct(solver_container[val_iZone][MESH_0][TURB_SOL]->node[iPoint]->GetHB_Source());
      }
    }
  }
